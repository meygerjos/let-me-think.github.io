...
The participants should conform to a schedule of meals and labor which is rigid in that specific times are chosen for specific days, but partial in that the period of scholarly time is self-structured. Those used to academic life will be correct in interpreting this not so much an imposition as a way to constrain the labor time with a hard upper bound.
